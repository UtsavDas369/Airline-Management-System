...
public class Mail {
	...
	public static void main(String[] args) {
		...
		String to = "utsav.das369@gmail.com";
		...
		try {
			...
			DataSource fds = new FileDataSource("E:\\JAVA MINI PROJECT\\AIRLINE\\Airline\\src\\images\\qantas-ad.jpg");
			...
			DataSource fds1 = new FileDataSource(
					"E:\\JAVA MINI PROJECT\\AIRLINE\\Airline\\src\\images\\ico_facebook.jpg");
			...
			DataSource fds2 = new FileDataSource(
					"E:\\JAVA MINI PROJECT\\AIRLINE\\Airline\\src\\images\\ico_instagram.jpg");
			...
			DataSource fds3 = new FileDataSource(
					"E:\\JAVA MINI PROJECT\\AIRLINE\\Airline\\src\\images\\ico_linkedin.jpg");
			...
			DataSource fds4 = new FileDataSource(
					"E:\\JAVA MINI PROJECT\\AIRLINE\\Airline\\src\\images\\ico_twitter.jpg");
			...
			// second part (the image)
			messageBodyPart = new MimeBodyPart();
			DataSource fds5 = new FileDataSource("E:\\JAVA MINI PROJECT\\AIRLINE\\Airline\\src\\images\\ticket.jpg");
