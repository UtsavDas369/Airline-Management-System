...
public class CartTable {
	...
	public CartTable(Integer pno, String fname, String lname, Integer flight_no, String source, String destination,
			String phone, String date, String category, Integer classid) {
		super();
