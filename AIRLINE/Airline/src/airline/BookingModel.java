...
public class BookingModel {
	...
	public void book(String pno, String fn, String ln, String fno, String src, String dest, String phon, String date,
			String category, String classid) throws SQLException {
		PreparedStatement preparedStatement = null;
		String query = "insert into booking (passport_no,fname,lname,flight_no,source,destination,phone,date,customer_id, category,classid)"
				+ "value(?,?,?,?,?,?,?,?,?,?,?)";
		try {
