...
//Add Flight Details (administrator)
public class AdminAddFlights {
	...
	// Check Database Connection whether it is connected or not
	...
	// Add Flights details to the DATABASE
	public void AddFlights(String fno, String model, String src, String dest, String dtime, String atime, String date,
			String radioButtonLabel1, String radioButtonLabel2, String radioButtonLabel3, String cap)
			throws SQLException {
		PreparedStatement preparedStatement = null;
		String query = "insert into add_flights(flight_no,flight_model,source,destination,departure_time,arrival_time,flight_date,mcheck,ercheck,wcheck,capacity)"
				+ "value(?,?,?,?,?,?,?,?,?,?,?)";
		try {
