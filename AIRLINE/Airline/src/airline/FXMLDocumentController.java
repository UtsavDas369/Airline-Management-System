...
public class FXMLDocumentController implements Initializable {
	...
	/*
	 * @FXML public void Flightadd(ActionEvent event) throws Exception { Stage
	 * primaryStage =new Stage(); primaryStage.initStyle(StageStyle.UNDECORATED);
	 * primaryStage.getIcons().add(new Image("/images/icon.png")); Parent root
	 * =FXMLLoader.load(getClass().getResource("AddFlights.fxml"));
	 * 
