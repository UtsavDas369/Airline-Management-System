...
public class CancelTable {
	...
	public CancelTable(Integer pno, String fname, String lname, Integer flight_no, String source, String destination,
			String phone, String date, Integer customer, String category, Integer classid) {
		super();
