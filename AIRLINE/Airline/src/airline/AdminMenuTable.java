...
public class AdminMenuTable {
	...
	public AdminMenuTable(Integer flight_no, String flight_model, String source, String destination,
			String departure_time, String arrival_time, String flight_date, String capacity) {
		super();
