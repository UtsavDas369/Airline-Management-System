...
//Add Flights Controller (Administrator)
public class AdminAddFlightsController implements Initializable {
	...
	public void Save(ActionEvent event) {
		...
		try {
			if ((fno.isEmpty() || model.isEmpty() || src.isEmpty() || dest.isEmpty() || dtime.isEmpty()
					|| atime.isEmpty() || cap.isEmpty())) {
				...
				alertLabel.setText(" ");
				Addf.AddFlights(fno, model, src, dest, dtime, atime, textdate.getValue().toString(), message1, message2,
						message3, cap);
